...
public abstract class LCData<Repr,Hom,A> implements __3<LCData.µ,Repr,Hom,A> {
    ...
    public static <Repr,Hom,A> LCData<Repr,Hom,A> narrow(__<__<__<µ,Repr>,Hom>,A> a) {
        return (LCData<Repr,Hom,A>)a;
    }
    ...
    public static <K, Tensor, Hom, U, A, B> Maybe<__2<K,A,B>> toCCC(CCC<K,Tensor,Hom> ccc, LCData<K,Hom,__3<Hom,K,A,B>> lcData) {
    ...
    private static <K,Tensor,Hom,U,A,B,C> Maybe<__2<K,A,B>> lamToCCC(CCC<K,Tensor,Hom> ccc, Lam<K,Hom,A,B,C> lam) {
    ...
    private static <K,Tensor,Hom,U,A,B,C,D> Maybe<__2<K,D,C>> lamLamToCCC(CCC<K,Tensor,Hom> ccc, int paramIdent, Lam<K,Hom,A,B,C> lam) {
    ...
    private static <K,Tensor,Hom,U,A> LCData<K,Hom,A> lamLamSubtFstSnd(CCC<K,Tensor,Hom> ccc, int paramIdent1, int paramIdent2, LCData<K,Hom,A> body) {
        return body.substDepthFirst(lamLamSubFstSndNF(ccc, paramIdent1, paramIdent2));
    }

    private static <K,Tensor,Hom,U> NF<__<__<µ, K>,Hom>,__<__<µ, K>,Hom>> lamLamSubFstSndNF(CCC<K,Tensor,Hom> ccc, int paramIdent1, int paramIdent2) {
        return new NF<__<__<µ, K>,Hom>,__<__<µ, K>,Hom>>() {
            @Override
            public <A> __<__<__<LCData.µ, K>, Hom>, A> apply(__<__<__<LCData.µ, K>, Hom>, A> this_) {
                return narrow(this_).match(new CasesAdapter<__<__<__<LCData.µ, K>, Hom>, A>, K,Hom,A>(this_) {
                    @Override
    ...
    private static <K,Tensor,Hom,U,A,B> LCData<K,Hom,__3<Hom, K, A, __3<Hom, K, B, A>>> fst(CCC<K,Tensor,Hom> ccc) {
        return LCData.lift(ccc.curry(ccc.exl()));
    }

    private static <K,Tensor,Hom,U,A,B> LCData<K,Hom,__3<Hom, K, A, __3<Hom, K, B, B>>> snd(CCC<K,Tensor,Hom> ccc) {
        return LCData.lift(ccc.curry(ccc.exr()));
    }

    private static <K,Tensor,Hom,U,A,B,C> Maybe<__2<K,C,B>> lamApToCee(CCC<K,Tensor,Hom> ccc, int paramIdent, Ap<K,Hom,A,B> ap) {
    ...
    private static <K,Tensor,Hom,U,A,B,C,D> Maybe<__2<K,D,C>> lamLiftToCCC(CCC<K,Tensor,Hom> ccc, Lift<K,Hom,A,B,C> lift) {
